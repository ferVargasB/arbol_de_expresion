#############################################################################
# Makefile for building: arbolDeExpresion.app/Contents/MacOS/arbolDeExpresion
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  arbolDeExpresion.pro
# Template: app
# Command: /Users/fernandovargas/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile arbolDeExpresion.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = arbolDeExpresion1.0.0
DISTDIR = /Users/fernandovargas/arbolDeExpresion/.tmp/arbolDeExpresion1.0.0
...
DIST          = ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		arbolDeExpresion.pro aplicacion.h \
		nodo.h main.cpp \
		aplicacion.cpp \
		nodo.cpp
QMAKE_TARGET  = arbolDeExpresion
DESTDIR       = 
TARGET        = arbolDeExpresion.app/Contents/MacOS/arbolDeExpresion
...
$(TARGET): ui_aplicacion.h $(OBJECTS)  
	@test -d arbolDeExpresion.app/Contents/MacOS/ || mkdir -p arbolDeExpresion.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: arbolDeExpresion.pro ../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile arbolDeExpresion.pro
...
arbolDeExpresion.app/Contents/PkgInfo: 
	@test -d arbolDeExpresion.app/Contents || mkdir -p arbolDeExpresion.app/Contents
	@$(DEL_FILE) arbolDeExpresion.app/Contents/PkgInfo
	@echo "APPL????" > arbolDeExpresion.app/Contents/PkgInfo
arbolDeExpresion.app/Contents/Resources/empty.lproj: 
	@test -d arbolDeExpresion.app/Contents/Resources || mkdir -p arbolDeExpresion.app/Contents/Resources
	@touch arbolDeExpresion.app/Contents/Resources/empty.lproj
	
arbolDeExpresion.app/Contents/Info.plist: 
	@test -d arbolDeExpresion.app/Contents || mkdir -p arbolDeExpresion.app/Contents
	@$(DEL_FILE) arbolDeExpresion.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,hjhj.arbolDeExpresion,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,arbolDeExpresion,g" -e "s,@LIBRARY@,arbolDeExpresion,g" -e "s,@TYPEINFO@,????,g" ../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >arbolDeExpresion.app/Contents/Info.plist

all: Makefile \
		arbolDeExpresion.app/Contents/PkgInfo \
		arbolDeExpresion.app/Contents/Resources/empty.lproj \
		arbolDeExpresion.app/Contents/Info.plist $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents aplicacion.h nodo.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp aplicacion.cpp nodo.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r arbolDeExpresion.app
